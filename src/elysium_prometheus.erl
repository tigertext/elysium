...
do_setup() ->
    Get_Connection_Duration_Buckets =
        case application:get_env(elysium, prometheus_default_cassandra_get_connection_duration_buckets, [25, 40, 60, 100, 125, 150, 200, 300, 450, 600, 800, 1000]) of
            {ok, V1} -> V1;
            V2 -> V2
        end,
    ...
    Exec_Cmd_Duration_Buckets =
        case application:get_env(elysium, prometheus_default_cassandra_exec_cmd_duration_buckets, [25, 40, 60, 100, 125, 150, 200, 300, 450, 600, 800, 1000]) of
            {ok, V3} -> V3;
            V4 -> V4
        end,
    prometheus_histogram:declare([
